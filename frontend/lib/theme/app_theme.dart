...
abstract final class AppText {
  ...
  static TextStyle get body => GoogleFonts.dmSans(
      fontSize: 14, height: 22 / 14, color: AppColors.textSecondary);
  static TextStyle get label =>
      GoogleFonts.dmSans(fontSize: 16, color: AppColors.textPrimary);
  static TextStyle get input => GoogleFonts.dmSans(
      fontSize: 16, fontWeight: FontWeight.w300, height: 1.5, color: AppColors.textPrimary);
  static TextStyle get button => GoogleFonts.dmSans(
      fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.primary50);
  ...
  static TextStyle get bodySmall => GoogleFonts.manrope(
      fontSize: 14, height: 20 / 14, color: AppColors.gray800);
  static TextStyle get caption => GoogleFonts.manrope(
      fontSize: 12, height: 18 / 12, color: AppColors.gray500);
}
